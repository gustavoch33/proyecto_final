...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/final.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/final.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/final.p1
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/final.p1: final.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/final.p1.d 
	@${RM} ${OBJECTDIR}/final.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/final.p1 final.c 
	@-${MV} ${OBJECTDIR}/final.d ${OBJECTDIR}/final.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/final.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
